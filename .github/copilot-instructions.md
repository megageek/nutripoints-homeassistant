...
- `entity/` — Base entity class (`NutriPointsEntity`)
...
- Entity MRO: `(PlatformEntity, NutriPointsEntity)` — order matters
...
- Debug level: `custom_components.nutri_points: debug` in `config/configuration.yaml`
